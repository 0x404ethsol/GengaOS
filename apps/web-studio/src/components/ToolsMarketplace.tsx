...
const TOOL_REGISTRY: ProviderTool[] = [
  // IMAGE
  {
    ...
    signupUrl: "https://fal.ai", freeiter: true, native: true, tier: "essential",
    freeiter: true, freeier: true, freeier: true,
    freeiter: false,
    freeier: false,
    freeier: false,
  } as unknown as ProviderTool,
  {
    ...
    signupUrl: "https://replicate.com", freeiter: true, native: false, tier: "essential",
    freeiter: true,
  } as unknown as ProviderTool,
  {
    ...
    signupUrl: "https://runpod.io", freeiter: false, native: true, tier: "pro",
    freeiter: false,
  } as unknown as ProviderTool,
  {
    ...
    signupUrl: "https://platform.stability.ai", freeiter: true, native: false, tier: "pro",
    freeiter: false,
  } as unknown as ProviderTool,
  ...
  // VIDEO
  {
    ...
    signupUrl: "https://klingai.com", freeiter: true, native: false, tier: "essential",
    freeiter: false,
  } as unknown as ProviderTool,
  {
    ...
    signupUrl: "https://runwayml.com", freeiter: true, native: false, tier: "pro",
    freeiter: false,
  } as unknown as ProviderTool,
  {
    ...
    signupUrl: "https://hailuoai.com", freeiter: true, native: false, tier: "pro",
    freeiter: false,
  } as unknown as ProviderTool,
  {
    ...
    signupUrl: "https://lumalabs.ai", freeiter: true, native: false, tier: "power",
    freeiter: false,
  } as unknown as ProviderTool,
  ...
  // CONSISTENCY
  {
    ...
    signupUrl: "https://astria.ai", freeiter: true, native: false, tier: "essential",
    freeiter: false,
  } as unknown as ProviderTool,
  ...
  // VOICE
  {
    ...
    signupUrl: "https://elevenlabs.io", freeiter: true, native: false, tier: "essential",
    freeiter: false,
  } as unknown as ProviderTool,
  {
    ...
    signupUrl: "https://suno.ai", freeiter: true, native: false, tier: "pro",
    freeiter: false,
  } as unknown as ProviderTool,
  ...
  // SCRIPT AI
  {
    ...
    signupUrl: "https://aistudio.google.com", freeiter: true, native: true, tier: "essential",
    freeiter: false,
  } as unknown as ProviderTool,
  {
    ...
    signupUrl: "https://platform.openai.com", freeiter: true, native: false, tier: "pro",
    freeiter: false,
  } as unknown as ProviderTool,
  {
    ...
    signupUrl: "https://anthropic.com", freeiter: true, native: false, tier: "power",
    freeiter: false,
  } as unknown as ProviderTool,
  ...
  // UPSCALE
  {
    ...
    signupUrl: "https://topazlabs.com/topaz-video-ai", freeiter: false, native: false, tier: "power",
    freeiter: false,
  } as unknown as ProviderTool,
];
...
const CLEAN_REGISTRY: ProviderTool[] = TOOL_REGISTRY.map(t => ({
  ...
  freeiter: (t as unknown as Record<string, unknown>).freeiter as boolean,
  native: t.native, tier: t.tier,
}));

// Deduplicate by id
const TOOLS = Array.from(new Map(CLEAN_REGISTRY.map(t => [t.id, t])).values()) as (ProviderTool & { freeiter: boolean })[];
...
export function ToolsMarketplace({ onStatus }: Props) {
  ...
  const saveKey = useCallback(async (toolId: string, key: string) => {
    ...
    // Optimistically store masked version locally
    // Production: POST to /v1/keys on control-api which encrypts and stores server-side
    await new Promise(r => setTimeout(r, 1200)); // Simulated verify
    ...
    setKeyInput("");
    onStatus(`✅ ${tool.name} connected — ${tool.capabilities[0]} now unlocked`);
